...
exports.generateRcuPdfReport = generateRcuPdfReport;
...
async function generateRcuPdfReport(caseData) {
    ...
    return new Promise(async (resolve, reject) => {
        try {
            ...
            const renderRow = (label, value, isHeader = false, valueColor = '#1E293B', isBoldValue = false) => {
                const startX = 36;
                const startY = doc.y;
