...
exports.reviewCase = exports.getVerificationDetail = exports.getCompletedCases = void 0;
...
const getCompletedCases = async (req, res) => {
    try {
        ...
        return (0, helpers_1.apiError)(res, 'Failed to load completed cases', 500, error);
    }
};
exports.getCompletedCases = getCompletedCases;
...
const getVerificationDetail = async (req, res) => {
    try {
        ...
        const data = {
            id: caseData.id,
            customer: {
                name: (0, helpers_1.parseFullName)(caseData.customer.firstName, caseData.customer.lastName),
        ...
        return (0, helpers_1.apiError)(res, 'Failed to load verification detail', 500, error);
    }
};
...
const reviewCase = async (req, res) => {
    try {
        ...
        await (0, helpers_1.createAuditLog)({
            ...
            entity: `Case ${caseId} — ${(0, helpers_1.parseFullName)(existingCase.customer.firstName, existingCase.customer.lastName)} (${existingCase.customer.applicationId})`,
            ip: req.ip || 'system',
            adminId,
        });
        ...
        return res.status(200).json({
            ...
            data: {
                ...
                agentName: (0, helpers_1.resolveAgentName)(existingCase.agent),
            },
        });
    }
    catch (error) {
        return (0, helpers_1.apiError)(res, 'Failed to review case', 500, error);
    }
};
exports.reviewCase = reviewCase;
