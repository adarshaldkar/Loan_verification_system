...
exports.resetPassword = exports.verifyResetOtp = exports.forgotPassword = exports.logoutUser = exports.loginUser = exports.registerAgent = void 0;
...
const loginUser = async (req, res) => {
    try {
        ...
        const token = jsonwebtoken_1.default.sign({ id: user.id, role: user.role, branch: user.branch, adminId: user.adminId }, JWT_SECRET, { expiresIn: '7d' });
